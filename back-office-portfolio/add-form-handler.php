...
if ($_SESSION['username']) {
    ...
    if ($_POST) {
        ...
        if (
            ...
            $sql = "INSERT INTO projet(project_tittle,project_begin	
,project_end,project_context,project_specs,project_githublink,project_link)VALUES(:project_tittle,:project_begin,:project_end,:project_context,:project_specs,:project_githublink,:project_link)";
